...
# Token a utilizar para reducir ruido (0 = primer token)
SELECTED_TOKEN = 0
...
def load_embeddings(path, population_label):
    ...
    for entry in data:
        ...
        # Usar el token seleccionado globalmente
        if SELECTED_TOKEN < embedding_matrix.shape[0]:
            token_embedding = embedding_matrix[SELECTED_TOKEN]
...
before = load_embeddings("../../essentia-models/maest/embeddings/before_2012-2025-05-08_maest.pkl", "Before 2012")
after = load_embeddings("../../essentia-models/maest/embeddings/after_2018-2025-05-08_maest.pkl", "After 2018")
...
plt.title("t-SNE of Maest Audio Embeddings (Colored by Population)")
plt.xlabel("t-SNE Dimension 1")
plt.ylabel("t-SNE Dimension 2")
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.tight_layout()

output_dir = "visualization_results/embedding_visualization_maest_by_feature"
...
def create_interactive_plot(color_by, title_suffix=None, show_legend=True, custom_labels=None):
    ...
    fig = px.scatter(
        ...
        title=f"Interactive t-SNE of Maest Audio Embeddings (Token {SELECTED_TOKEN}) (Colored by {title_suffix})",
        labels={
            "x": "t-SNE Dimension 1", 
            "y": "t-SNE Dimension 2", 
